  ...
  validator: {
    $jsonSchema: {
      ...
      properties: {
        ...
        fecha_registro: { bsonType: 'timestamp' },
        recomendado: { bsonType: 'string' },
        direccion: {
          bsonType: 'object',
          title: 'direccion',
          properties: {
...
db.createCollection('gafa', {
  validator: {
    $jsonSchema: {
      bsonType: 'object',
      title: 'gafa',
      required: ['gafa_id', 'proveedor'],
      properties: {
        gafa_id: { bsonType: 'objectId' },
        graduacion_derecha: { bsonType: 'double' },
        graduacion_izquierda: { bsonType: 'double' },
        color_montura: { bsonType: 'string' },
        color_cristal_derecho: { bsonType: 'string' },
        color_cristal_izquierdo: { bsonType: 'string' },
        precio: { bsonType: 'double' },
        tipo_montura: {
          bsonType: 'object',
          title: 'tipo_montura',
          properties: {
            flotante: { bsonType: 'bool' },
            pasta: { bsonType: 'bool' },
            metalica: { bsonType: 'bool' },
          },
        },
        marca: {
          bsonType: 'object',
...
db.createCollection('pedido', {
  validator: {
    $jsonSchema: {
      bsonType: 'object',
      title: 'pedido',
      required: ['pedido_id', 'gafa', 'empleado', 'cliente'],
      properties: {
        pedido_id: { bsonType: 'objectId' },
        fecha_pedido: { bsonType: 'timestamp' },
        gafa: { bsonType: 'objectId' },
